...
# python demo.py --device cuda ../../mmdetection/demo/demo.mp4  \
#     ../../models/MMDet/configs/panoptic_fpn/panoptic-fpn_r101_fpn_ms-3x_coco.py \
#     ../../models/MMDet/panoptic_fpn_r101_fpn_mstrain_3x_coco_20210823_114712-9c99acc4.pth \
#     --out ./output.mp4