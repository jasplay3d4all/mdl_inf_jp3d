...
module.exports = function () {
    ...
    module.pipeline_state = {
        name: "single_state",
        cur_stage_idx: 0,
        //pipe_line: pipe_ctrl_multiple_img_gen: mainly used to generate multiple images using single text prompt and a sample image given.
        ...
        stage_state:[{
            ...
            //gen_img(theme, prompt, op_fld, control_type=None, ctrl_img_path=None, n_prompt="", height=512, width=512,seed=-1, num_images=1, safety_checker=None, collect_cache=True)
              config:{ 
                  ...
                  prompt:{val : "RAW photo, jasmine flowers with dew drops on it,8k uhd, dslr, soft lighting, high quality, film grain, Fujifilm XT3 ", 
                  ...
                  control_type: {val: "zoe_depth", label: "contol_type", show: true, type: "default"},
