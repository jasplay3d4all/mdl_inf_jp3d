module.exports = function () {
    ...
    module.pipeline_state = {
        name: "single_state",
        cur_stage_idx: 0,
        pipe_info:{label:"gen_vdo_with_ado_pipe", id:"gen_vdo_with_ado"}, //Not sure whether it is required
        user_state:{
            info:{
                id:"JAYKANIDAN",
            },
        ...
        stage_state:[{
            ...
            //:sd_mdl = sd_model(theme=theme, control_type=control_type, safety_checker=safety_checker)
              config:{ 
                    ...
                    prompt:{val :"RAW photo, close up of girl twins in summer wear in a lawn, looking at me, (best quality, \
                                highest quality), (ultra detailed),(8k, 4k, intricate),(highly detailed:1.2), (detailed face:1.2),(gradients),\
                                (ambient light:1.3)",
